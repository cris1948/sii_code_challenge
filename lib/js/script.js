...
var MOVIEDB_AUTHENTICATE_URL = 'https://www.themoviedb.org/authenticate/';
...
var MovieDB = {
  ...
  searchMovie: function searchMovie(textQuery, page) {
    var _this = this;

    this.makeRequest('searchMovie', { query: textQuery, page: 1 }).then(function (response) {
  ...
  authenticateUser: function authenticateUser(textQuery) {
    ...
    this.makeRequest('getToken').then(function (response) {
